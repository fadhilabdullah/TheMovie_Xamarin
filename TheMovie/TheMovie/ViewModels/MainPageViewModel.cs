...
using static TheMovie.Models.Enums;
...
namespace TheMovie.ViewModels
{
    public class MainPageViewModel : BaseViewModel
    {
        ...
        public async Task <List<Genre>> GetGenres_dropdown()
        {
            //var listGenre = new List<Genre>();

            //var searchMovies = await ApiService.GetGenresAsync().ConfigureAwait(false);
            //if (searchMovies != null)
            //{
            //    var genres = new List<Genre>();
            //    foreach (var genre in searchMovies)
            //    {
            //        genres.Add(genre);
            //    }
            //    listGenre.AddRange(genres);
            //}
            List<Genre> data = new List<Genre>();
            //data.Add(new States("Alabama"));

            var genre = await ApiService.GetGenresAsync().ConfigureAwait(false);
